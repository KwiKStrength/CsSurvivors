package Interface.InterfaceUser.Dashboard.mode;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        Icon lightIcon = new ImageIcon(getClass().getResource("/mode/light.png"));
        Icon darkIcon = new ImageIcon(getClass().getResource("/mode/dark.png"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new ImageIcon(getClass().getResource("/mode/light.png")));
        } else {
            buttonLighDark.setIcon(new ImageIcon(getClass().getResource("/mode/light.png")));
        }
    }
