package Interface.InterfaceUser.Dashboard;

import Interface.InterfaceUser.Dashboard.mode.LightDarkMode;
import Interface.InterfaceUser.Dashboard.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String headerName = "Campus Grill";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/Image/LogoDash.png")));
